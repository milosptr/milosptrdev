...
function Timeline() {
  ...
  return (
    <div className='pointer-events-none absolute inset-0 z-50 overflow-hidden lg:right-[calc(max(2rem,50%-38rem)+50rem)] lg:min-w-[32rem] lg:overflow-visible'>
      <svg
...
function Glow() {
  ...
  return (
    <div className='absolute inset-0 -z-10 overflow-hidden bg-gray-950 lg:right-[calc(max(2rem,50%-38rem)+50rem)] lg:min-w-[32rem]'>
      <svg
...
function FixedSidebar({ main, footer }) {
  return (
    <div className='relative flex-none overflow-hidden px-6 lg:pointer-events-none lg:fixed lg:inset-0 lg:z-40 lg:flex lg:px-0'>
      <Glow />
      <div className='relative flex w-full lg:pointer-events-auto lg:mr-[calc(max(2rem,50%-38rem)+50rem)] lg:min-w-[32rem] lg:overflow-y-auto lg:overflow-x-hidden lg:pl-[max(4rem,calc(50%-48rem))]'>
        <div className='mx-auto max-w-lg lg:mx-0 lg:flex lg:w-[28rem] lg:max-w-none lg:flex-col lg:before:flex-1 lg:before:pt-6'>
